...
import { InseratWizard } from '../../../../verkaeufer/inserat/components/InseratWizard';
import { applySmartDefaults } from '@/lib/inserat-smart-defaults';

export const metadata = { title: 'Mandat bearbeiten — passare Broker' };
...
export default async function BrokerMandatEditPage({ params, searchParams }: Props) {
  ...
  if (!row) notFound();
  // Im Broker-Bereich MUSS broker_id matchen
  if (row.broker_id !== userData.user.id) notFound();
    ...
    <div className="px-6 md:px-10 py-8 md:py-12">
      <div className="max-w-3xl mx-auto">
        <Link
          ...
          className="inline-flex items-center gap-1.5 text-caption text-quiet hover:text-navy transition-colors mb-6"
        >
