...
const STAGES = [
  { delay: 0,    label: 'Agentur-Profil bestätigt' },
  { delay: 700,  label: 'Broker-Abo aktiviert' },
          ...
          {paid ? (
            <>
              ...
              <p className="text-body-lg text-muted mt-3 max-w-md mx-auto leading-relaxed">
                Dein Broker-Konto ist startklar. Wir richten dein Dashboard ein.
              </p>
            </>
          ) : (
            <>
              ...
              <p className="text-body-lg text-muted mt-3 max-w-md mx-auto leading-relaxed">
                Wir richten dein Broker-Dashboard ein.
              </p>
            </>
          )}
        </div>
