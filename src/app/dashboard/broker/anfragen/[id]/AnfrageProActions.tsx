...
/**
 * Pro-Action-Sidebar bei Broker-Anfrage-Detail.
 *
 * Analog zur Verkäufer-Variante. Berechtigung prüft `broker_id` statt
 * `verkaeufer_id`.
 */
      ...
      {!isPro ? (
        ...
        <div className="space-y-2">
          ...
          <p className="text-caption text-quiet leading-snug pt-1">
            Der Käufer sieht nur was du explizit teilst.
          </p>
        </div>
      )}
