...
import { ArrowRight, Search, MapPin, TrendingUp, Users, Calendar, FileLock2, Building2, Filter, Heart } from 'lucide-react';
...
export const metadata = {
  title: 'Firmen entdecken — passare',
  description:
    'Aktuelle Schweizer KMU-Inserate. Filtern nach Branche, Kanton, Umsatz und EBITDA. Öffentlicher Teaser gratis, Detail-Dossier nach Registrierung und NDA-Signatur.',
  robots: { index: false, follow: false },
};

/**
 * /kaufen — Direktes Marktplatz-Portal
 * Nicht klassische Landingpage, sondern die Inserate-Liste.
 * Unregistrierte sehen Teaser. Für Anfragen: Registrierung nötig.
 */
      ...
      <Container>
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <nav className="hidden md:flex items-center gap-9">
            ...
            <Link href="/kaufen" className="text-[0.8125rem] font-medium text-navy">Entdecken</Link>
    ...
    <Section className="pt-14 md:pt-20 pb-10">
      <Container>
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 max-w-content">
          <div>
            <Reveal>
              <p className="overline mb-4 text-bronze-ink">Marktplatz</p>
          ...
          <Reveal delay={0.1}>
            <p className="text-body text-muted max-w-md leading-relaxed">
              <span className="font-mono text-[11px] uppercase tracking-widest text-navy">{LISTINGS.length} aktive Inserate</span> &middot;
              anonymer Teaser gratis sichtbar. Für Dossier-Anfrage und NDA-Signatur
              genügt eine kostenlose Registrierung.
            </p>
          </Reveal>
        </div>
      </Container>
            ...
            <Reveal>
              <div className="flex items-center justify-between mb-6 pb-4 border-b border-stone flex-wrap gap-3">
                <p className="font-mono text-[11px] uppercase tracking-widest text-quiet">
                  <span className="text-navy font-medium">{LISTINGS.length} Inserate</span> &middot; aktualisiert 24.04.2026
                </p>
