  ...
  return (
    <div className="flex flex-col gap-2 mb-4 lg:flex-row lg:items-center lg:justify-between">
      <div className="flex items-center gap-1 flex-wrap">
        <span className="text-[11px] text-quiet uppercase tracking-wide font-medium mr-1">
          Rolle
        </span>
        {ROLE_FILTERS.map((f) => {
      ...
      <div className="relative w-full lg:w-72">
        ...
        <input
          ...
          className="w-full pl-8 pr-8 py-1 bg-paper border border-stone rounded-soft text-[13px] placeholder:text-quiet focus:outline-none focus:border-bronze"
        />
        {query && (
          <button
            type="button"
