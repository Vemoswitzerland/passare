...
/**
 * Avatar + Name + Logout-Menü unten links in der Sidebar.
 * Pattern wie Slack/Linear/Notion — Account-Menü öffnet nach oben.
 */
export function SidebarUserFooter({ email, fullName }: Props) {
